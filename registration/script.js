document.addEventListener('DOMContentLoaded', () => {
    ...
    const signButton = document.getElementById('gs');
    const signButton2 = document.getElementById('sign');
  ...
  function displayContentBasedOnRole() {
    if (loggedInUser) {
        ...
        signButton2.style.display = 'none';
  ...
  if (logoutButton) {
    logoutButton.addEventListener('click', () => {
        ...
        signButton2.style.display = 'inline';
    });
  }
